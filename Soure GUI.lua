...
local Window = OrionLib:MakeWindow({Name = "Gengar Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Gengar Hub"})

OrionLib:MakeNotification({
	Name = "Gengar Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://138566611177503",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://138566611177503",
    PremiumOnly = false
})
